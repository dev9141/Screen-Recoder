...
import com.manddprojectconsultant.screencam.activity.BackgroundActivity;
import com.manddprojectconsultant.screencam.activity.BlankActivity;
import com.manddprojectconsultant.screencam.activity.DashboardActivity;
import com.manddprojectconsultant.screencam.activity.NotificationRecordingStartActivity;
...
//                params.y = 0;
        ...
        mFloatingViewExpand.findViewById(R.id.iv_Home).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FloatingViewService.this, DashboardActivity.class).putExtra("OpenHome", true).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_EXCLUDE_FROM_RECENTS | Intent.FLAG_ACTIVITY_NO_ANIMATION));
                backgroundActivity.finish();
                expandedView.setVisibility(View.GONE);
            }
        });
